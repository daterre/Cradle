/*
------------------------------------------------
Generated by Cradle 2.0.0.0 on 5/22/2016 6:59:00 PM
...
public partial class @SnoozingStoryV2: Cradle.StoryFormats.Sugar.SugarStory
{
	...
	IStoryThread passage1_Main()
	{
		...
		{
			yield return lineBreak();
			yield return link(@"snooze=", @"no snooze", null);
			yield return lineBreak();
		}
		else
		{
	...
	IStoryThread passage8_Main()
	{
		...
		yield return lineBreak();
		yield return text(@"Everyone");
		yield return lineBreak();
		yield return text(@"is going to hate me.");
		yield return lineBreak();
		yield return text(@"I'm a clown");
		yield return lineBreak();
		yield return text(@"Why do I");
		yield return lineBreak();
		yield return link(@"continue=", @"alarm", null);
		yield return lineBreak();
		yield break;
	...
	IStoryThread passage12_Main()
	{
		...
		yield return lineBreak();
		yield return lineBreak();
		yield return text(@"i'll go deep");
		yield return lineBreak();
		yield return lineBreak();
		yield return text(@"just sleep");
		yield return lineBreak();
		Vars.click = false;
		yield return lineBreak();
		yield return link(@"continue=", @"alarm", null);
	...
	void passage13_Init()
	{
		this.Passages[@"no snooze"] = new StoryPassage(@"no snooze", new string[]{  }, passage13_Main);
	}

	#line 1 "no snooze"
	IStoryThread passage13_Main()
	{
		yield return text(@"This is too much.");
		yield return lineBreak();
		yield return lineBreak();
		yield return link(@"Time to get up.", @"getUp", null);
		yield return lineBreak();

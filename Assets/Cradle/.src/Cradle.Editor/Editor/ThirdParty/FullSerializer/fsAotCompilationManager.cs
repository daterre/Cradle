...
using System.Text;
using Cradle.Editor.ThirdParty.FullSerializer.Internal;
...
namespace Cradle.Editor.ThirdParty.FullSerializer {
    ...
    public class fsAotCompilationManager {
        ...
        private static string GenerateDirectConverterForTypeInCSharp(Type type, fsMetaProperty[] members, bool isConstructorPublic) {
            ...
            sb.AppendLine();
            sb.AppendLine("namespace Cradle.Editor.ThirdParty.FullSerializer {");
            ...
            sb.AppendLine("}");
            sb.AppendLine();
			sb.AppendLine("namespace Cradle.Editor.ThirdParty.FullSerializer.Speedup {");

/*
------------------------------------------------
Generated by Cradle 2.0.0.0 on 5/16/2016 1:28:55 PM
...
public partial class @HarloweTests: Cradle.StoryFormats.Harlowe.HarloweStory
{
	...
	IStoryThread passage16_Main()
	{
		...
		using (ApplyStyle("hook", hook("eb79ecf6fa694b98ae05ec54335ab396")))
			yield return link("Link macro", null, () => enchantHook("eb79ecf6fa694b98ae05ec54335ab396", HarloweEnchantCommand.Replace, passage16_Fragment_0));
	...
	IStoryThread passage17_Main()
	{
		...
		yield return lineBreak();
		yield return lineBreak();
		using (ApplyStyle("hook", hook("27076470501849e8bf0f0f0f50a3b307")))
			yield return link("Click and it's gone", null, () => enchantHook("27076470501849e8bf0f0f0f50a3b307", HarloweEnchantCommand.Replace, passage17_Fragment_0));
		yield return lineBreak();
		yield return lineBreak();
		using (ApplyStyle("hook", hook("cbefe0c7c76c48898a9b0b9e6d1f0015")))
			yield return link("Click and it's gone", null, () => enchantHook("cbefe0c7c76c48898a9b0b9e6d1f0015", HarloweEnchantCommand.Replace, passage17_Fragment_1));
		yield return lineBreak();
		yield return lineBreak();
		using (ApplyStyle("hook", hook("26cb2bf7974645f083385a31301449f9")))
			yield return link("What comes next?", null, () => enchantHook("26cb2bf7974645f083385a31301449f9", HarloweEnchantCommand.Replace, passage17_Fragment_2, linkTextPrefix: true));
		
		yield return lineBreak();
		yield return lineBreak();
		yield return link("How long are you here?", null, () => enchantHook("143f1b46fec841d196cdb54b0c8f2ae1", HarloweEnchantCommand.Replace, passage17_Fragment_3, wrap: true));
		using (ApplyStyle("hook", hook("143f1b46fec841d196cdb54b0c8f2ae1"))) {}
		yield break;
	}

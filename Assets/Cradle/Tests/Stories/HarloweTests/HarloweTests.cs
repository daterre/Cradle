/*
------------------------------------------------
Generated by Cradle 2.0.0.0 on 7/24/2016 11:35:54 AM
...
public partial class @HarloweTests: Cradle.StoryFormats.Harlowe.HarloweStory
{
	...
	IStoryThread passage16_Main()
	{
		...
		using (ApplyStyle("hook", hook("64e554ce41074b72973cf072b72b2047")))
			yield return link("Link macro", null, () => enchantHook("64e554ce41074b72973cf072b72b2047", HarloweEnchantCommand.Replace, passage16_Fragment_0));
	...
	IStoryThread passage17_Main()
	{
		...
		yield return lineBreak();
		yield return lineBreak();
		using (ApplyStyle("hook", hook("12279c4d26e54096ad08978ae383ca9e")))
			yield return link("Click and it's gone", null, () => enchantHook("12279c4d26e54096ad08978ae383ca9e", HarloweEnchantCommand.Replace, passage17_Fragment_0));
		yield return lineBreak();
		yield return lineBreak();
		using (ApplyStyle("hook", hook("052a015ae5b0426083b6a655012c1990")))
			yield return link("Click and it's gone", null, () => enchantHook("052a015ae5b0426083b6a655012c1990", HarloweEnchantCommand.Replace, passage17_Fragment_1));
		yield return lineBreak();
		yield return lineBreak();
		using (ApplyStyle("hook", hook("67393781653644d8be43528e4098b067")))
			yield return link("What comes next?", null, () => enchantHook("67393781653644d8be43528e4098b067", HarloweEnchantCommand.Replace, passage17_Fragment_2, linkTextPrefix: true));
		
		yield return lineBreak();
		yield return lineBreak();
		yield return link("How long are you here?", null, () => enchantHook("94908190b4ad4d17afd9e61d1553b95b", HarloweEnchantCommand.Replace, passage17_Fragment_3, wrap: true));
		using (ApplyStyle("hook", hook("94908190b4ad4d17afd9e61d1553b95b"))) {}
		yield break;
	}

/*
------------------------------------------------
Generated by Cradle 2.0.0.0 on 3/12/2017 10:57:23 PM
...
public partial class @HarloweTests: Cradle.StoryFormats.Harlowe.HarloweStory
{
	...
	IStoryThread passage16_Main()
	{
		...
		using (Group("hook", "45c196"))
			yield return link("Link macro", null, () => enchantHook("45c196", HarloweEnchantCommand.Replace, passage16_Fragment_0));
	...
	IStoryThread passage17_Main()
	{
		...
		yield return lineBreak();
		yield return lineBreak();
		using (Group("hook", "73c71e"))
			yield return link("Click and it's gone", null, () => enchantHook("73c71e", HarloweEnchantCommand.Replace, passage17_Fragment_0));
		yield return lineBreak();
		yield return lineBreak();
		using (Group("hook", "26965f"))
			yield return link("Click and it's gone", null, () => enchantHook("26965f", HarloweEnchantCommand.Replace, passage17_Fragment_1));
		yield return lineBreak();
		yield return lineBreak();
		using (Group("hook", "1b6c83"))
			yield return link("What comes next?", null, () => enchantHook("1b6c83", HarloweEnchantCommand.Replace, passage17_Fragment_2, linkTextPrefix: true));
		
		yield return lineBreak();
		yield return lineBreak();
		yield return link("How long are you here?", null, () => enchantHook("c2eb3c", HarloweEnchantCommand.Replace, passage17_Fragment_3));
		using (Group("hook", "c2eb3c")) {}
		yield break;
	}

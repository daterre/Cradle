...
using System.Linq;
using System.Text;
using UnityTwine.Editor.ThirdParty.FullSerializer;
...
namespace UnityTwine.Editor.Utils
{
	public static class PhantomJS
	{
		...
		{
			string binPath =
				Application.platform == RuntimePlatform.OSXEditor ? "/UnityTwine/Editor/ThirdParty/PhantomJS/bin/osx/phantomjs" :
				Application.platform == RuntimePlatform.WindowsEditor ? "/UnityTwine/Editor/ThirdParty/PhantomJS/bin/win/phantomjs.exe" :
				null;

/*
------------------------------------------------
Generated by UnityTwine 2.0.0.0 on 5/15/2016 1:13:02 PM
...
public partial class @HarloweTests: UnityTwine.StoryFormats.Harlowe.HarloweStory
{
	...
	ITwineThread passage16_Main()
	{
		...
		using (ApplyStyle("hook", hook("825e54269e9b45e4915813286e211a49")))
			yield return link("Link macro", null, () => enchantHook("825e54269e9b45e4915813286e211a49", HarloweEnchantCommand.Replace, passage16_Fragment_0));
	...
	ITwineThread passage17_Main()
	{
		...
		yield return lineBreak();
		yield return lineBreak();
		using (ApplyStyle("hook", hook("d23f8d75ccf341d5847e978687ef16b5")))
			yield return link("Click and it's gone", null, () => enchantHook("d23f8d75ccf341d5847e978687ef16b5", HarloweEnchantCommand.Replace, passage17_Fragment_0));
		yield return lineBreak();
		yield return lineBreak();
		using (ApplyStyle("hook", hook("c048cada7fd644fb9571a228cc7beea6")))
			yield return link("Click and it's gone", null, () => enchantHook("c048cada7fd644fb9571a228cc7beea6", HarloweEnchantCommand.Replace, passage17_Fragment_1));
		yield return lineBreak();
		yield return lineBreak();
		using (ApplyStyle("hook", hook("0b6d07104bf84faaa604ac877d88ec3b")))
			yield return link("What comes next?", null, () => enchantHook("0b6d07104bf84faaa604ac877d88ec3b", HarloweEnchantCommand.Replace, passage17_Fragment_2, linkTextPrefix: true));
		
		yield return lineBreak();
		yield return lineBreak();
		yield return link("How long are you here?", null, () => enchantHook("bffc7f6193394478817af915621965b0", HarloweEnchantCommand.Replace, passage17_Fragment_3, wrap: true));
		using (ApplyStyle("hook", hook("bffc7f6193394478817af915621965b0"))) {}
		yield break;
	}

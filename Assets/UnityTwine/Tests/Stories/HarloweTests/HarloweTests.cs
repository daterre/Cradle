/*
------------------------------------------------
Generated by UnityTwine 2.0.0.0 on 5/9/2016 4:20:40 PM
...
public partial class @HarloweTests: UnityTwine.StoryFormats.Harlowe.HarloweStory
{
	...
	ITwineThread passage16_Main()
	{
		...
		using (ApplyStyle("hook", hook("fef727ff1562487396cca8cc221c7b11")))
			yield return link("Link macro", null, () => enchantHook("fef727ff1562487396cca8cc221c7b11", HarloweEnchantCommand.Replace, passage16_Fragment_0));
	...
	void passage17_Init()
	{
		this.Passages["Macros_Links"] = new TwinePassage("Macros_Links", new string[]{  }, passage17_Main);
	}
	...
	ITwineThread passage17_Main()
	{
		...
		yield return lineBreak();
		yield return lineBreak();
		using (ApplyStyle("hook", hook("a4952a1e63d34c3899a9ef31b651bffc")))
			yield return link("Click and it's gone", null, () => enchantHook("a4952a1e63d34c3899a9ef31b651bffc", HarloweEnchantCommand.Replace, passage17_Fragment_0));
		yield return lineBreak();
		yield return lineBreak();
		using (ApplyStyle("hook", hook("6d1b18c64b7a49b3ae4d8146c3373a04")))
			yield return link("Click and it's gone", null, () => enchantHook("6d1b18c64b7a49b3ae4d8146c3373a04", HarloweEnchantCommand.Replace, passage17_Fragment_1));
		yield return lineBreak();
		yield return lineBreak();
		using (ApplyStyle("hook", hook("83bd875d1eaf43bbba7d86c93310b7f7")))
			yield return link("What comes next?", null, () => enchantHook("83bd875d1eaf43bbba7d86c93310b7f7", HarloweEnchantCommand.Replace, passage17_Fragment_2, linkTextPrefix: true));
		
		yield return lineBreak();
		yield return lineBreak();
		yield return link("How long are you here?", null, () => enchantHook("e047cf3bda0e4f34adf765e05fd36a3b", HarloweEnchantCommand.Replace, passage17_Fragment_3, wrap: true));
		using (ApplyStyle("hook", hook("e047cf3bda0e4f34adf765e05fd36a3b"))) {}
		yield break;
	}
	...
	void passage18_Init()
	{
		this.Passages["Macros_Clicks"] = new TwinePassage("Macros_Clicks", new string[]{  }, passage18_Main);
	}

/*
------------------------------------------------
Generated by UnityTwine 2.0.0.0 on 5/9/2016 2:31:50 PM
...
public partial class @HarloweTests: UnityTwine.StoryFormats.Harlowe.HarloweStory
{
	...
	void passage2_Init()
	{
		this.Passages["Vars_Type_String"] = new TwinePassage("Vars_Type_String", new string[]{  }, passage2_Main);
	}
	...
	void passage3_Init()
	{
		this.Passages["Vars_Type_Bool"] = new TwinePassage("Vars_Type_Bool", new string[]{  }, passage3_Main);
	}
	...
	void passage4_Init()
	{
		this.Passages["Vars_Type_Number"] = new TwinePassage("Vars_Type_Number", new string[]{  }, passage4_Main);
	}
	...
	void passage5_Init()
	{
		this.Passages["Markup_Scope_Styles"] = new TwinePassage("Markup_Scope_Styles", new string[]{  }, passage5_Main);
	}
	...
	void passage6_Init()
	{
		this.Passages["Markup_HTML"] = new TwinePassage("Markup_HTML", new string[]{ "NoException", }, passage6_Main);
	}
	...
	void passage7_Init()
	{
		this.Passages["Markup_Verbatim"] = new TwinePassage("Markup_Verbatim", new string[]{  }, passage7_Main);
	}
	...
	void passage8_Init()
	{
		this.Passages["Markup_Unsupported"] = new TwinePassage("Markup_Unsupported", new string[]{  }, passage8_Main);
	}
	...
	void passage9_Init()
	{
		this.Passages["Markup_LineBreaks"] = new TwinePassage("Markup_LineBreaks", new string[]{  }, passage9_Main);
	}
	...
	void passage10_Init()
	{
		this.Passages["Markup_NakedVar"] = new TwinePassage("Markup_NakedVar", new string[]{  }, passage10_Main);
	}
	...
	void passage11_Init()
	{
		this.Passages["Markup_Scope_Hooks"] = new TwinePassage("Markup_Scope_Hooks", new string[]{  }, passage11_Main);
	}
	...
	void passage12_Init()
	{
		this.Passages["Vars_It"] = new TwinePassage("Vars_It", new string[]{  }, passage12_Main);
	}
	...
	void passage13_Init()
	{
		this.Passages["Vars_Type_Array"] = new TwinePassage("Vars_Type_Array", new string[]{  }, passage13_Main);
	}
	...
	void passage14_Init()
	{
		this.Passages["Vars_Type_Dataset"] = new TwinePassage("Vars_Type_Dataset", new string[]{  }, passage14_Main);
	}
	...
	void passage15_Init()
	{
		this.Passages["Vars_Type_Datamap"] = new TwinePassage("Vars_Type_Datamap", new string[]{  }, passage15_Main);
	}
	...
	void passage16_Init()
	{
		this.Passages["Markup_Links"] = new TwinePassage("Markup_Links", new string[]{  }, passage16_Main);
	}
	...
	ITwineThread passage16_Main()
	{
		...
		using (ApplyStyle("hook", hook("b52cd417293e47abaead4efac6cef4b0")))
			yield return link("Link macro", null, () => enchantHook("b52cd417293e47abaead4efac6cef4b0", HarloweEnchantCommand.Replace, passage16_Fragment_0));
	...
	ITwineThread passage16_Fragment_0()
	{
		yield break;
	}
	...
	void passage17_Init()
	{
		this.Passages["Macros_LinkTypes"] = new TwinePassage("Macros_LinkTypes", new string[]{  }, passage17_Main);
	}

	#line 1 "Macros_LinkTypes"
	ITwineThread passage17_Main()
	{
		yield return link("Result", "Result", null);
		yield return lineBreak();
		yield return lineBreak();
		using (ApplyStyle("hook", hook("163de638f4ae486e83f4028590ca60de")))
			yield return link("Click and it's gone", null, () => enchantHook("163de638f4ae486e83f4028590ca60de", HarloweEnchantCommand.Replace, passage17_Fragment_0));
		yield return lineBreak();
		yield return lineBreak();
		using (ApplyStyle("hook", hook("0c51e4b5199648bca125f37595f85371")))
			yield return link("Click and it's gone", null, () => enchantHook("0c51e4b5199648bca125f37595f85371", HarloweEnchantCommand.Replace, passage17_Fragment_1));
		yield return lineBreak();
		yield return lineBreak();
		using (ApplyStyle("hook", hook("59f1063e79ce449abc34dea9acdcd97b")))
			yield return link("What comes next?", null, () => enchantHook("59f1063e79ce449abc34dea9acdcd97b", HarloweEnchantCommand.Replace, passage17_Fragment_2, linkTextPrefix: true));
		
		yield return lineBreak();
		yield return lineBreak();
		yield return link("How long are you here?", null, () => enchantHook("2159b84a3e6d461c9f3fde583a3ba5d8", HarloweEnchantCommand.Replace, passage17_Fragment_3, wrap: true));
		using (ApplyStyle("hook", hook("2159b84a3e6d461c9f3fde583a3ba5d8"))) {}
		yield break;
	}

	#line 1 "Macros_LinkTypes#frag#0"
	ITwineThread passage17_Fragment_0()
	{
		yield return text("It's gone.");
		yield break;
	}
	#line 1 "Macros_LinkTypes#frag#1"
	ITwineThread passage17_Fragment_1()
	{
		yield return text("It's gone.");
		yield break;
	}
	#line 1 "Macros_LinkTypes#frag#2"
	ITwineThread passage17_Fragment_2()
	{
		yield return text("This does!");
		yield break;
	}
	#line 1 "Macros_LinkTypes#frag#3"
	ITwineThread passage17_Fragment_3()
	{
		if(this.PassageTime < 10000) {

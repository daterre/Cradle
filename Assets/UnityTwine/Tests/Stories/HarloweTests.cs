/*
------------------------------------------------
Generated by UnityTwine 2.0.0.0 on 5/5/2016 11:57:02 PM
...
public partial class @HarloweTests: UnityTwine.StoryFormats.Harlowe.HarloweStory
{
	...
	// .............
	// #6: Markup_Scope_Styles

	void passage6_Init()
	{
		this.Passages["Markup_Scope_Styles"] = new TwinePassage("Markup_Scope_Styles", new string[]{  }, passage6_Main);
	}
	...
	// .............
	// #12: Markup_Scope_Hooks

	void passage12_Init()
	{
		this.Passages["Markup_Scope_Hooks"] = new TwinePassage("Markup_Scope_Hooks", new string[]{  }, passage12_Main);
	}
	...
	ITwineThread passage18_Main()
	{
		...
		yield return link("Link macro", null, passage18_Fragment_0);

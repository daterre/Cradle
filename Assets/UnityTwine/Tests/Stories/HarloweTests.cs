/*
------------------------------------------------
Generated by UnityTwine 2.0.0.0 on 5/4/2016 11:36:51 AM
...
public partial class @HarloweTests: UnityTwine.StoryFormats.Harlowe.HarloweStory
{
	...
	{
		var c1 = Context.Apply(HarloweContext.Hook, "c1"); if (c1) using (c1) {
			yield return text("ballroom");
			macros2.assertContext("hook", "c1");
		}
		yield return lineBreak();
		var c2 = Context.Apply(HarloweContext.Hook, "c2"); if (c2) using (c2) {
	...
	{
		yield return link("Result", "Result", null, contextInfo(HarloweContext.LinkType, "linkgoto"));
		macros2.assertLink("Result", "Result", "Link without text");
		yield return link("Link classic", "Result", null, contextInfo(HarloweContext.LinkType, "linkgoto"));
		macros2.assertLink("Link classic", "Result");
		yield return link("Link right", "Result", null, contextInfo(HarloweContext.LinkType, "linkgoto"));
		macros2.assertLink("Link right", "Result");
		yield return link("Link left", "Result", null, contextInfo(HarloweContext.LinkType, "linkgoto"));
		macros2.assertLink("Link left", "Result");
		yield return link("Link-goto macro", "Result", null, contextInfo(HarloweContext.LinkType, "linkgoto"));
		macros2.assertLink("Link-goto macro", "Result");
		yield return link("Link macro", null, passage18_Fragment_0, contextInfo(HarloweContext.LinkType, "link"));
